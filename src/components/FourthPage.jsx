...
export const FourthPage = () =>{
  ...
  return(
    <>
      ...
      <div className="w-full h-[90vh] font-gta1 bg-gradient-to-r from-[#ef8469] via-[#f4be7a] to-[#ef8469] bg-clip-text text-transparent flex items-center justify-center gap-60">
