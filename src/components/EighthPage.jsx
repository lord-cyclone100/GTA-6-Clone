...
export const EighthPage = () => {
  ...
  return(
    <>
      <div id="dimez-page" className="w-full h-[408vh] relative bg-emerald-900">
      ...
      <div id="hey-dimez" className="relative h-[280vh] w-full bg-gradient-to-tr from-[#323953] to-[#525973] overflow-x-hidden">
        ...
        <div className="flex flex-col gap-40">
          ...
          <div id="dimez-page" className="w-1/2 flex flex-col gap-6 -right-30 top-200 absolute">
        ...
        {/* <div className="absolute transform left-1/2 top-400 h-dvh bg-amber-300"> */}
          <img id="port-gellhorn" src="./images/port-gellhorn-postcard.svg" className="h-[98vh] absolute top-300 left-1/2 transform -translate-x-1/2 z-70" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} alt="" />
        {/* </div> */}
      </div>
    </>
  )
