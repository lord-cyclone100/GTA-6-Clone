    ...
    <>
      ...
      <div id="hey-raul" className="relative h-[280vh] w-full bg-gradient-to-tr from-[#2c4234] to-[#223329] overflow-x-hidden">
        ...
        {/* <div className="absolute transform left-1/2 top-400 h-dvh bg-amber-300"> */}
          <img id="ambrosia" src="./images/ambrosia-postcard.svg" className="h-[98vh] absolute top-300 left-1/2 transform -translate-x-1/2 z-70" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} alt="" />
        {/* </div> */}
      </div>
    </>
  )
